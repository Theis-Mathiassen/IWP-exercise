...
export {noRounds,playRound,roll,isSpecialRound, newScoreBoard,roundsText,getTotalScore};
...
function getTotalScore(scoreBoard){
  return scoreBoard[rounds.total].score;
}

/* 
// MAIN NOW handled by YatzyGame Object
